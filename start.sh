...
slapd slapd/domain string ${LDAP_DOMAIN:-agem.com.tr}
slapd shared/organization string ${LDAP_ORGANISATION:-AGEM Bilisim}
...
exec nohup slapd -h "ldap:/// ldapi:///" -u openldap -g openldap ${LDAP_OPTS:-} -d ${LDAP_DEBUG:-"stats"} &
